          ...
          render={(formikBag: FormikProps<iFormValues>) => (
            <Form>
              ...
              <Input 
                ...
                error={formikBag.touched.user_name ? (formikBag.errors.user_name || '') : ''}
              />
              ...
              <Input 
                ...
                onChange={formikBag.handleChange}
                onBlur={formikBag.handleBlur}
                error={formikBag.touched.password_confirmation ? (formikBag.errors.password_confirmation || '') : ''}
              />

              <div className="field">
                <div className="control">
                  <label className="register__text--small  checkbox">
                    <Field className="register__checkbox" name="consent" type="checkbox" />
                     I agree to the <a href="#">terms and conditions</a>
                  </label>
                </div>
                <p className="help is-success">{formikBag.touched.consent && formikBag.errors.consent}</p>
              </div>
              
              <div className="field">
                <p className="control">
                  <button className="button" type="submit" disabled={!formikBag.isValid}>Sign up</button>
                </p>
              </div>
            </Form>
          )}
